    ...
    <>
      {isLargerThanMD ? (
        <Flex
          ...
          overflow="hidden"
        >
          <Box w="60%" h="100%" color="white" flex="1" display="flex" flexDirection="column" justifyContent="center" px={20}>
        ...
        <Flex
          ...
          overflow="hidden"
        >
          <Box w="100%" color="white" flex="1" display="flex" flexDirection="column" justifyContent="center" px={{ base: 6, sm: 12 }} py={16}>
